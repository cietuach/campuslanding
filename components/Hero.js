        ...
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a
              ...
              className="text-sm font-semibold leading-6 text-gray-900"
            >
              Descarga la app <span aria-hidden="true">&rarr;</span>
            </a>
          </div>
        </nav>
        <Dialog
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Campus Seguro</span>
                <img
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              por nuestros guardias de seguridad, a su vez, permite enviar
              quejas por violencia de género directamente a la defensoría de los
          ...
          <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
            ...
            >
              ...
              >
                <img
                  src="https://res.cloudinary.com/djlx5smmq/image/upload/v1683922269/WhatsApp_Image_2023-05-12_at_14.10.17_kgwsug.jpg"
                  alt=""
                />
              </foreignObject>
            </svg>
